...
const EmailForm = () => {
  ...
  return (
    <form className='grid max-w-xl gap-4' onSubmit={submit}>
      ...
      <EmailComposeFields messageMinHeightClass='min-h-40' ref={composeRef} />
    ...
    <div className='grid gap-4'>
      <div className='grid gap-2'>
        ...
        <p className='text-sm text-muted-foreground'>
          ...
          {' '}
          <Link className='underline underline-offset-2' href='/members/roster'>
            roster
          </Link>
          {' '}
